		...
		if($pic['type']=="image/jpg" || $pic['type']=="image/jpeg" || $pic['type']=="image/png" ||$pic['type']=="image/gif"){
			if($pic['size']<=614400)
			{
				...
				if(mysqli_num_rows($result)==0)
				{
					...
					Product_ID, Product_Name, Price, SmallDesc, DetailDesc, Pro_qty, Pro_image, Cat_ID, ProDate)
					VALUES ('$id','$proname',$price,'$short','$detail', $qty,'$filePic','$category','".date('Y-m-d H:i:s')."')";
					mysqli_query($conn,$sqlstring);
